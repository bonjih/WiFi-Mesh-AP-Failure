...
#Given a certain time (t-2,t-1,t), predict the when the CPU utilisation (%) will go greater than 80%
...
# Given the CPU utilisation at time (t), in %, what is the CPU utilisation at time t+1? 
